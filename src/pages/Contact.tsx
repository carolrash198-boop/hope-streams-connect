                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="bg-green-50 dark:bg-green-950/20 rounded-lg p-3 border border-green-200 dark:border-green-800">
                              <p className="text-xs font-medium text-green-700 dark:text-green-400 mb-1">Lost? Contact us on WhatsApp</p>
                              <a 
                                href="https://wa.me/254722570556?text=Hello,%20I%20need%20help%20finding%20the%20church%20location"
                                target="_blank"
                              ...
                              <p className="text-xs text-muted-foreground mt-1">Message us for directions</p>
                            </div>
                          </div>
                        </div>
                      </CardContent>
